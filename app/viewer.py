"""Runtime TUI viewer extensions for compact provider/use-case selection and responsive download actions."""
...
class AIModelViewer(BaseAIModelViewer):
    ...
    def _apply_ui_mode(self) -> None:
        """Apply base layout, then keep the runtime use-case selector visible."""
